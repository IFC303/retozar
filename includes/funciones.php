<?php
            ...
            function nombreLog(){
                    ...
                    echo "Bienvenido " . ucwords($fila['nombre']); //ucwords acentos y ñ...
            ...
            function listardepartamentos(){
                    ...
                    $solucion .= "<option value=''>-- Seleccione un departamento --</option>";

                    while ($fila = $consulta->fetch(PDO::FETCH_ASSOC)) {
                        $departamentos = $fila['departamento'];
                        $departamentos = ucfirst($departamentos); //primer caracter en mayuscula
